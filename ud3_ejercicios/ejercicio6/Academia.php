...
final class Profesor extends Persoa implements Comparar
{
    ...
    public function __construct($nombre, $apellidos, $edad, $movil, $dni)
    {
        parent::__construct($nombre, $apellidos, $movil);
        $this->dni = $dni;
        $this->edad = $edad;
...
$profesor1 = new Profesor('Fran', 'García Fernández', 33, 654582395, '35368106K');
$profesor2 = new Profesor('Emma', 'García Rey', 24, 635988421, '74566852A');
...
echo '<br>Comparar edad<br>';
echo 'Profesor Fran: ';
$profesor1->comparar($profesor2);
echo '<br>Profesor Emma: ';
$profesor2->comparar($profesor1);